          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
              ...
              <ul class="menu-dropdown">
                ...
                <li class="active"><a href="buttons.html"><i class="ion ion-ios-circle-outline"></i> Buttons</a></li>
          ...
          <div class="section-body">
            ...
            <div class="row">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Buttons <code>.btn-lg</code></h4>
                  </div>
                  <div class="card-body">
                    <a href="#" class="btn btn-lg">Default</a>
                    ...
                    <a href="#" class="btn btn-lg btn-dark">Dark</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="row mt-4">
              ...
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  <div class="card-header">
                    <h4>Buttons <code>.btn-sm</code></h4>
                  </div>
                  <div class="card-body">
                    <a href="#" class="btn btn-sm">Default</a>
                    ...
                    <a href="#" class="btn btn-sm btn-dark">Dark</a>
                  </div>
                </div>
              </div>
            </div>
